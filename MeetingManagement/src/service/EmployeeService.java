...
public class EmployeeService {
	...
	public int login(String username, String password) {
		...
		if (employee != null) {
			...
			if (status != null && status.equals(CommonConstant.STATUS1)) {
				flag = Integer.parseInt(CommonConstant.STATUS1);
			}
			//String STATUS2="1"; //审核通过，登录成功
			if (status != null && status.equals(CommonConstant.STATUS2)) {
				flag = Integer.parseInt(CommonConstant.STATUS2);
			}
